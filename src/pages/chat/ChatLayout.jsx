...
const ChatLayout = ({
  ...
  const content = (
    <div className={`flex flex-col h-full ${fontFamily.main} shadow-[100px_100px_100px_100px_rgba(0,0,0,0.1)] bg-white rounded-[20px] ${variant === 'settings' ? 'px-0 py-0' : 'px-20 py-10'}`}>
